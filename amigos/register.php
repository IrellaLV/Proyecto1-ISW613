...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Llama a la función para insertar el amigo
    insert_amigo($nombre, $apellidos, $telefono, $correo, $direccion, $pais, $contrasena);
...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <form method="POST" class="bg-white p-4 border rounded shadow-sm">
            ...
            <a href="login.php" class="btn btn-success btn-block">Iniciar Sesión</a>
        </form>
    </div>
